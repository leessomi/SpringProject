...
<link rel="stylesheet" href="/resources/css/member/join.css">
	<div class="join-wrapper" id="wrap">
        <h2>마이페이지 수정</h2>
        <form id="operForm" action='pageModify' method="post">
        	...
        	<div class="field">
            	...
            	<b>이메일</b>
            	<input type="email" name="memberMail" value="${member.memberMail}" required>

	            <b>주소</b>
	            <div>
	            	<input class="addr_input_1" type="text" id="input1" name="memberAddr1" value="${member.memberAddr1}">
	            	<input type="button" id="input2" value="주소찾기" onclick="daum_address()"> 
	            </div>
	            <input class="addr_input_2" type="text" name="memberAddr2" value="${member.memberAddr2}">
	            <input class="addr_input_3" type="text" name="memberAddr3" value="${member.memberAddr3}">
	            
	            <sec:authentication property="principal" var="pinfo"/>
	            <div class="d-flex justify-content-center">
	            	<button type="button" onclick="location.href='../member/myPage?memberId=${pinfo.username}'" class="btn btn-outline-dark">취소</button>&nbsp;&nbsp;
